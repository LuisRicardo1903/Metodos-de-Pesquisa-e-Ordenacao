...
public class NJPesquisaOrdenacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jButtonGerarNumeros, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabelSelecao)
                        .addComponent(jLabelBolha)
                        .addComponent(jLabelInsercao)))
    ...
    private void jButtonSelecionarArquivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarArquivoActionPerformed
        ...
        if (i == 1) { // 1 = nenhum arquivo selecionado
            ...
            importarDadosArquivo(arquivo.getPath());
        }
     ...
     private void importarDadosArquivo(String arquivo) {
        ...
        try {
            ...
            while ((linha = br.readLine()) != null) {
                ...
                jTANumerosSelecionados.append(linha+"\n");
